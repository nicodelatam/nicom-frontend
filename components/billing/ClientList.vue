...
export default {
  ...
  computed: {
    ...
    currentCity () {
      ...
      return this.$store.state.company.cities ? this.$store.state.company.cities.find(c => c.name == this.$route.query.city) : ''
    },
    pagination () {
  ...
  methods: {
    ...
    async getClientBySearch () {
      ...
      if (!this.fuzzy && !this.newclient) {
        await this.$store.dispatch('client/getServicesFromDatabaseBySearch', { search, company: this.$route.query.company, city: this.$route.query.city, clienttype: this.$route.query.clienttype, token: this.$store.state.auth.token, page: this.page })
        this.loadingDataTable = false
        this.result = `No se han encontrado resultados de ${search} en ${this.$route.query.city}`
      } else if (!this.fuzzy && this.newclient) {
        await this.$store.dispatch('client/getClientsFromDatabaseBySearch', { search, company: this.$route.query.company, city: this.$route.query.city, clienttype: this.$route.query.clienttype, token: this.$store.state.auth.token })
        this.loadingDataTable = false
        this.result = `No se han encontrado resultados de ${search} en ${this.$route.query.city}`
      } else if (this.fuzzy && !this.newclient) {
        await this.$store.dispatch('client/getServicesFromDatabaseByFuzzySearch', { search, company: this.$route.query.company, city: this.$route.query.city, clienttype: this.$route.query.clienttype, token: this.$store.state.auth.token })
        this.loadingDataTable = false
        this.result = `No se han encontrado resultados de ${search} en ${this.$route.query.city}`
      }
    },
