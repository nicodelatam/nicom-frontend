    ...
    processDni () {
      ...
      this.$store.dispatch('password/searchClientByDni', {
        ...
        if (res.length > 0) {
          ...
          this.$toast.error('No se ha encontrado ningun usuario con esta informacion. Comunicate al 301 7161658 en Mariquita y al 350 810 59 49 en Fresno', { position: 'bottom-center' })
        }
      })
    }
  },
