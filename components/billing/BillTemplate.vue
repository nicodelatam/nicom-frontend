  ...
  <v-card v-if="bill && company" id="billPrint" class="elevation-0 bill-card" light>
    <div class="header-section">
      ...
      <div class="receipt-info">
        <div class="receipt-box">
          <h5 class="receipt-title">RECIBO</h5>
          <h5 class="receipt-number">{{ bill.id }}</h5>
          <h5 class="receipt-code">CÓDIGO: {{ bill.service.code }}</h5>
        </div>
      </div>
    </div>
    ...
    <div class="user-data-grid">
      <div class="user-data-section">
        ...
        <div class="data-value">{{ bill.service.client_name }}</div>
      </div>

      <div class="user-data-section">
        <div class="data-label">NO. DOCUMENTO</div>
        <div class="data-value">{{ bill.service.dni }}</div>
      </div>

      <div class="user-data-section">
        <div class="data-label">SERVICIO</div>
        <div class="data-value">{{ bill.service.offer.name }}</div>
      </div>

      <div class="user-data-section">
        <div class="data-label">DIRECCIÓN DE DOMICILIO</div>
        <div class="data-value">{{ bill.service.address }}</div>
      </div>

      <div class="user-data-section">
        <div class="data-label">BARRIO</div>
        <div class="data-value">{{ bill.service.neighborhood }}</div>
      </div>

      <div class="user-data-section">
        <div class="data-label">ID DEL USUARIO</div>
        <div class="data-value">CÓDIGO: {{ bill.service.code }}</div>
      </div>

      <div class="user-data-section">
        <div class="data-label">CELULAR</div>
        <div class="data-value">{{ bill.service.phone }}</div>
      </div>

      <div class="user-data-section">
        <div class="data-label">CORREO ELECTRÓNICO</div>
        <div class="data-value">{{ bill.service.normalized_client.email }}</div>
      </div>
