...
export default {
  ...
  computed: {
    ...
    selectedClienttype () {
      return this.$store.state.company.clienttypes ? this.$store.state.company.clienttypes.find(c => c.name === this.$route.query.clienttype) : ''
    },
    selectedCompany () {
      return this.$store.state.auth.companies ? this.$store.state.auth.companies.find(c => c.name === this.$route.query.company) : ''
    },
  ...
  methods: {
    ...
    async refreshTickets () {
      ...
      await this.$store.dispatch('ticket/getTicketsFromDatabase', { company: this.selectedCompany.name, tickettype: this.selectedType.name, city: this.$route.query.city, clienttype: this.$route.query.clienttype, token: this.$store.state.auth.token, active: this.showClosedValue, retired: this.showRetired, page: this.page })
    ...
    changeView (view) {
      ...
      this.$router.push({ query: { company: this.$route.query.company, city: this.$route.query.city, clienttype: this.$route.query.clienttype, view } })
    ...
    saveAssignatedFromModal (ticket, index) {
      if (this.currentTechnician.phone) {
